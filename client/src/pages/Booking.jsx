    ...
    <div className="bg-black text-white">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <p className="text-center text-gray-300 mb-8 text-sm sm:text-base">
          Share your details below or confirm your slot instantly on WhatsApp.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="customerName" className="block text-sm font-medium text-gray-200 mb-1">
              Name *
            </label>
            <input
              id="customerName"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="timeSlot" className="block text-sm font-medium text-gray-200 mb-1">
                Time *
              </label>
              <select
                id="timeSlot"
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-6 py-3 bg-accent-gold text-black font-medium rounded-full hover:brightness-110 disabled:opacity-60 transition"
            >
            ...
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full border border-accent-gold/70 text-accent-gold font-medium hover:bg-white/5 transition"
            >
